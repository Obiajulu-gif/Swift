...
import "@suiet/wallet-kit/style.css"; // Import necessary styles

export default function ConnectWallet() {
	const { connected, account } = useWallet(); // Access wallet connection details

	return (
		<div>
			<ConnectButton /> {/* Renders the "Connect Wallet" button */}
			{connected && account ? (
				<div>Connected to {account.address}</div> // Display connected wallet address
			) : (
